...
export default function SignUpScreen(props) {
  ...
  const _signUp = async (values) => {
    ...
    try {
      ...
      setAlert({
        ...
        message:
          "You have registered an account correctly and you can go to the login page. Do you want to go to the login page?",
        type: "question",
      });
      setVisible(true);
    } catch (e) {
  ...
  return (
    <ScrollView>
      <Loader title="Creating a new account..." loading={loading} />
      <Alert
        visible={visible}
        title={alert.title}
      ...
      <View style={styles.container}>
        ...
        <Text h4>Register a new account</Text>
      </View>
      <KeyboardAvoidingView behavior="padding" enabled>
        <View style={styles.container}>
          <ProfileForm
            ...
            user={null}
            disabled={false}
            buttonTittle="Register an account"
            checkBox={true}
          />
        </View>
      </KeyboardAvoidingView>
